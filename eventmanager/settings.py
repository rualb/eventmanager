...
SECRET_KEY = 's6n*-w3)^m%3#)!y2s*83xah#^hybqg2ghnqm%sn#9j0+&90rj'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'runtime/cache'),
        'TIMEOUT': 300,
        'OPTIONS': {
